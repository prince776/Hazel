...
namespace Hazel { 
	...
	struct Renderer2DData
	{
		...
		static const uint32_t MaxTextureSlots = 32; // TODO: Check it.
		...
		uint32_t TextureSlotIndex = 1; // Since 0 is white texture.
	...
	void Renderer2D::Init()
	{
		...
		// Quad Vertex positions (centered on origin, size 1)
